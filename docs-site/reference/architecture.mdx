...
that accrued before it entered. That is what closes just-in-time liquidity.

## Custody

Custody reduces to one equation, asserted as a stateful invariant over 8,192 lifecycle calls:
...
flowchart TB
    ...
    subgraph OPEN["Permissionless"]
      ANY["Anyone<br/>swaps, queues liquidity,<br/>activates, cancels, claims"]
    end
