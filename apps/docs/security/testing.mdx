---
title: "Test suites"
description: "182 Foundry cases across 19 suites, and what each one is there to prove."
---

Foundry reports 182 passing cases: 168 KNOT-authored checks plus 14 inherited OpenZeppelin harness
methods. Live integration paths use the canonical v4 `PoolManager`; hostile token contracts are
isolated negative fixtures. Source-only coverage is **99.19% lines**, **96.44% statements**,
**82.61% branches**, and **100% functions**.
...
| `KnotFederationAttack` | 8 | Buddy-pool influence, membership, and three-member portfolio counterfactuals |
| `Fuzz` | 12 | Bound, rounding and monotonicity under randomized input |

The suite contains 28 fuzz properties. A high-depth run passed 10,000 runs per property.
